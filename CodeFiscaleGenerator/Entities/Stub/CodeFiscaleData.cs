...
namespace CodeFiscaleGenerator.Entities.Stub
{
    ...
    public class CodeFiscaleData
    {
        public CodeFiscaleData()
        {
            AccountCodeMigrationResponseCode = -1;
            IdentificationDocumentUpdateResponseCode = -1;
            Subregistration2ResponseCode = 1024;
        ...
        [XmlAttribute(AttributeName = "subregistration2ResponseCode")]
        public int Subregistration2ResponseCode { get; set; }
